...
class FarmgoodShow extends Component {
    ...
    componentWillMount(){
        ...
        //debugger 
        console.log(farmerID, farmgoodID)
    ...
    componentWillReceiveProps(nextProps){
        debugger 
        this.setState({
            farmgood: nextProps.farmgood.editing
        })
    }

    listOfFarmGoods(){
        const fg = this.state.farmgood.editing
        //debugger 
        console.log(fg)
        return (
            <div className="defaultText">
            {fg.attributes != undefined &&
                <div>
    ...
    render(){
        ...
        var displayFarmgood = ""
        //debugger 
        if (this.state.farmgood.editing != undefined ) {
            //debugger
            if (this.state.farmgood.editing.length === undefined) {
                debugger

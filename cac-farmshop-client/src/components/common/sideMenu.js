        ...
        switch(sessionStorage.role){
            case 'customer':
                return (
                    <Menu right>
                        ...
                        <a id="farm-goods" className="menu-item" href="/farmgoods">Farmgoods</a>
            ...
            return (
                <Menu right>
                    ...
                    <a id="farm-goods" className="menu-item" href="/farmgoods">My Farmgoods</a>
                    <button id="logout" className="menu-item" onClick={() => this.props.logout(this)}>Log Out</button>
                    <a onClick={ this.showSettings } className="menu-item--small" />
                </Menu>
            )
            case 'admin':
              ...
              return (
                <Menu right>
                    ...
                    <a id="farmers" className="menu-item" href="/farmers">Farmers</a>
                    <a id="farmgoods" className="menu-item" href="/farmgoods">Farmgoods</a>
